...
Looking at the plot we can see that LAC had the highest average over the years 2009-2018 while STL had the lowest.
...
Looking at the above the team that had the highest average yards gained over the years 2009-2018 was PHI.
...
**Categorical variables of interest:** - `play_type` - fundamental to understanding offensive strategy - `down` - critical game situation variable - `qtr` - temporal aspect of the game - `season` - allows for year-over-year comparisons

...
ggplot(nfl_runpass, aes(x = yards_gained)) +
  ...
  labs(
    ...
    subtitle = "Blue line = mean, Red line = median",
    x = "Yards gained",
    y = "Number of Plays"
  ) +
...
There is a subtle widening of the spread near the end of games (toward 0 minutes), especially for pass plays — likely reflecting more aggressive play-calling late in games as teams attempt deeper passes or comeback drives. \## add one more plot maybe
